...
from core.models import ScanConfig, FileMetadata, SymlinkMode
...
class TestSymlinkHandler:
    ...
    def test_loop_detection(self, tmp_path):
        ...
        assert handler.check_loop(a.resolve()) is False
        # Second visit should detect loop
        assert handler.check_loop(b.resolve()) is True
