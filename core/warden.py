...
from core.models import IncidentSeverity, IncidentType, WardenIncident, WardenZone
...
class FileSystemWarden:
    ...
    def __init__(self,
        ...
        self.handler: WardenEventHandler | None = None
        self.running = False
    ...
    def _find_zone(self, path: str) -> WardenZone | None:
    ...
    async def _check_permissions(self, path: Path, zone: WardenZone) -> dict | None:
    ...
    async def _check_naming(self, path: Path, zone: WardenZone) -> dict | None:
    ...
    async def _check_classification(self, path: Path, zone: WardenZone) -> dict | None:
